function [Ff, inliers_idx_star, n_inliers_star,sampson_dist_mat] = norm_8p_algo_RANSAC(m1,m2)
N = 500;             %No. of iterations 
%For the first 150 iterations we tune the threshold, and for remaining 350
%iterations we run RANSAC
...
dist_thresh = 1800;           %tune the inliers distance threshold here
